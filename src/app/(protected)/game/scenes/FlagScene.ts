...
export class FlagScene extends Phaser.Scene {
    ...
    create(): void {
        ...
        this.dianaText = this.add.text(this.scale.width - 20, 60, 'V:' + this.config.sfx.toString, { fontSize: '18px', backgroundColor: 'rgba(96, 96, 96, 0.20)', padding: { x: 10, y: 5 } }).setOrigin(1, 0).setScrollFactor(0).setDepth(10000);
    ...
    playSfx(sprite: string, volume: number = 1) {
        ...
        this.sound.playAudioSprite('sfx', sprite, { volume: finalVolume });
    }
