      ...
      <header style={{
        ...
        <div style={{ display: 'flex', gap: '8px', flexShrink: 0 }}>
          ...
          <button onClick={() => setActiveTab('leaderboard')}
            className="h-10 px-2 flex items-center justify-center bg-[radial-gradient(ellipse_at_center,#3a0402_0%,#4F0603_45%,#000000_100%)] text-white border-2 border-[#D1851F] rounded-lg transition-all duration-200 active:scale-95 whitespace-nowrap">
            🏆 <span className="ml-1 text-xs bg-gradient-to-b from-yellow-300 to-orange-500 bg-clip-text text-transparent">#123</span>
          </button>
        </div>

        {/* DERECHA: Este es el que debe adaptarse si el espacio es crítico */}
        <div style={{ minWidth: 0, flexShrink: 1 }}>
          <button className="h-10 px-2 w-full flex items-center justify-center bg-[radial-gradient(ellipse_at_center,#3a0402_0%,#4F0603_45%,#000000_100%)] border-2 border-[#D1851F] rounded-lg overflow-hidden">
